...
export default function SegmentMenu({top, left, isSegment, isAddPositivePoint, handleIsAddPositivePoint, handleSegment}: SegmentMenuProps) {
    ...
    return (
        <div className="absolute flex flex-col" style={{top: top, left: left}}>
            ...
            {/*
            <Button id="negativePoint" Icon={IoIosRemoveCircleOutline} tooltipText={tooltipTexts["negativePoint"]} shortcut="n"/>
